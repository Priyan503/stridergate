...
const JWT_SECRET = process.env.JWT_SECRET || 'shieldedrider-demo-secret-2026';

// Demo workers for login selection
export const DEMO_WORKERS = [
  { workerId: 'W001', name: 'Arun Kumar',   platform: 'Swiggy', city: 'Bengaluru', zone: 'Koramangala' },
  { workerId: 'W002', name: 'Shruthi Mehra', platform: 'Zomato', city: 'Chennai',   zone: 'Anna Nagar'   },
  { workerId: 'W003', name: 'Kmunar Sinha',  platform: 'Swiggy', city: 'Mumbai',    zone: 'Andheri East' },
  { workerId: 'W004', name: 'Nithin Kumar',   platform: 'Zomato', city: 'Hyderabad', zone: 'Banjara Hills'},
];
