...
let workers = [
  { workerId: 'W001', name: 'Arun Kumar',   city: 'Bengaluru', zone: 'Koramangala',  pincode: '560034', platform: 'Swiggy',  earnings: 4200, plan: 'Standard', premium: 67, bcs: 82, status: 'active',   claims: 2, joined: '2026-02-10', verified: true,  lat: 12.9352, lng: 77.6245 },
  { workerId: 'W002', name: 'Shruthi Mehra', city: 'Chennai',   zone: 'Anna Nagar',   pincode: '600040', platform: 'Zomato',  earnings: 3800, plan: 'Basic',    premium: 44, bcs: 91, status: 'active',   claims: 0, joined: '2026-01-28', verified: true,  lat: 13.0827, lng: 80.2187 },
  { workerId: 'W003', name: 'Kmunar Sinha',  city: 'Mumbai',    zone: 'Andheri East', pincode: '400069', platform: 'Swiggy',  earnings: 5100, plan: 'Max',      premium: 96, bcs: 34, status: 'flagged',  claims: 5, joined: '2026-01-15', verified: false, lat: 19.1136, lng: 72.8697 },
  { workerId: 'W004', name: 'Nithin Kumar',   city: 'Hyderabad', zone: 'Banjara Hills',pincode: '500034', platform: 'Zomato',  earnings: 3500, plan: 'Basic',    premium: 41, bcs: 74, status: 'active',   claims: 1, joined: '2026-02-20', verified: true,  lat: 17.4123, lng: 78.4480 },
];
let nextId = 5;
