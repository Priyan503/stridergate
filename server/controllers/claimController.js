...
let claims = [
  { claimId: 'CLM-0042', workerId: 'W001', worker: 'Arun Kumar',   zone: 'Koramangala',  trigger: 'Heavy Rain',  amount: 280, status: 'paid',     bcs: 82, time: '14:32', date: 'Apr 3',  adminNote: '' },
  { claimId: 'CLM-0041', workerId: 'W004', worker: 'Nithin Kumar',   zone: 'Banjara Hills',trigger: 'Heavy Rain',  amount: 210, status: 'paid',     bcs: 74, time: '11:20', date: 'Apr 3',  adminNote: '' },
  { claimId: 'CLM-0040', workerId: 'W003', worker: 'Kmunar Sinha',  zone: 'Andheri East', trigger: 'Heavy Rain',  amount: 380, status: 'flagged',  bcs: 34, time: '09:15', date: 'Apr 2',  adminNote: 'GPS anomaly detected' },
  { claimId: 'CLM-0039', workerId: 'W001', worker: 'Arun Kumar',   zone: 'Koramangala',  trigger: 'Severe AQI', amount: 180, status: 'paid',     bcs: 88, time: '16:50', date: 'Mar 28', adminNote: '' },
  { claimId: 'CLM-0038', workerId: 'W003', worker: 'Kmunar Sinha',  zone: 'Andheri East', trigger: 'Heavy Rain',  amount: 380, status: 'rejected', bcs: 28, time: '08:00', date: 'Mar 25', adminNote: 'Fraud pattern confirmed' },
];
let nextClaimNum = 43;
